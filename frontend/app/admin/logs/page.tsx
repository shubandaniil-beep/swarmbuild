  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-2">
        ...
        <button onClick={load}
                className="border border-zinc-700 px-4 py-2 rounded-lg text-sm hover:border-indigo-400">
          Обновить
        </button>
      </div>
        ...
        <tbody>
          {activity.map((r) => (
            <tr key={r.id} className="border-b border-zinc-900">
              ...
              <td className="text-indigo-300">{r.action}</td>
        ...
        <tbody>
          {rows.map((r, i) => (
            <tr key={i} className="border-b border-zinc-900">
              ...
              <td className="text-indigo-300">{r.mandate}</td>
