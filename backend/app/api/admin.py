...
from ..models import (AgentCall, CreditTopup, ModelEntry, Project, ProjectType, Provider,
                      ProviderKey, SystemSetting, Tariff, User, UserActivity)
from ..services import credit_pricing
from ..services import key_pool
...
def _is_private_host(host: str) -> bool:
    ...
    try:
        ...
        raise HTTPException(400, "base_url host cannot be resolved")
    for info in infos:
        addr = info[4][0]
        try:
